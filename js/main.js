...
// Home page six content texts selected
...
contentsText.forEach((contentText) => {
  ...
  contentText.addEventListener('click', () => chooseNewPage(targetText))
})

// Select action in home page
function chooseNewPage(targetText) {
  switch (targetText) {
    case 'New Match':
...
function selectTeamFunction() {
  ...
  selectTeamBtn.addEventListener('click', () => {
    ...
    allP[1].addEventListener('click', () => {
      const informationText = `
      <h3>Help</h3>
      <p>Selected teams are displayed in this section.</p><br>
      <p>By clicking on a team, you have the option to select a team for the game or to delete it from this list.</p><br>
      <p>Click on Delete all to delete the entire team list.</p><br>
      <p>The Back button returns you to the previous field.</p><br>
      <p>Click on the add team icon to go to the page for creating teams.</p>
      <button class="infoContentBtn">OK</button>
      `
      infoDiv.setAttribute('class', 'info-div-content')
      infoDiv.innerHTML = informationText
...
function addTeamFunction() {
  ...
  addTeamBtn.addEventListener('click', () => {
    ...
    allP[0].addEventListener('click', () => {
      const informationText = `
      <h3>Help</h3>
      <p>All the players you have entered and saved are displayed here.</p><br>
      <p>Check the boxes next to the players to put them in the same team and click OK.</p><br>
      <p>You must tag at least two players to put them on the same team.</p><br>
      <p>If you change your mind, press the Cancel button or the Back button, which returns you to the previous page.</p>
      <button class="infoContentBtn">OK</button>
      `
      infoDiv.setAttribute('class', 'info-div-content')
      infoDiv.innerHTML = informationText
  ...
  okBtn.addEventListener('click', () => {
    let selectedPlayerBoxes = document.querySelectorAll('.selected-player-box')
...
// Add team to match function END
